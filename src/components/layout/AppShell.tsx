...
const NAV: NavItem[] = [
  ...
  { to: "/laboratorio", label: "Laboratorio", icon: ClipboardList, soloMedico: true },
  { to: "/estudios-complementarios", label: "Otros estudios complementarios", icon: ClipboardList, soloMedico: true },
  { to: "/cirugias", label: "Cirugías", icon: ClipboardList, soloMedico: true },
  { to: "/formatos", label: "Formatos de historia", icon: FileText, soloMedico: true },
